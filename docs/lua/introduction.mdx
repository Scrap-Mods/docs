...
Use [print](/docs/lua/Game-Script-Environment/static_functions/Global#print) to print data to the console. <br></br>
...
such as creating a part using [sm.shape.createPart](/docs/lua/Game-Script-Environment/static_functions/sm.shape#createpart). <br></br>
...
Scrap Mechanic uses userdata to add game objects such as a [Shape](/docs/lua/Game-Script-Environment/Userdata/Shape) and utility objects such as [Vec3](/docs/lua/Game-Script-Environment/Userdata/Vec3). <br></br>
...
Here is an example where the member function [getColor](/docs/lua/Game-Script-Environment/Userdata/Shape#getcolor) is called on the [Shape](/docs/lua/Game-Script-Environment/Userdata/Shape) userdata:
```lua
...
The color returned by [getColor](/docs/lua/Game-Script-Environment/Userdata/Shape#getcolor) is another userdata type; [Color](/docs/lua/Game-Script-Environment/Userdata/Color). That color can be used as a parameter to [setColor](/docs/lua/Game-Script-Environment/Userdata/Shape#setcolor):
...
Another way to get a [Color](/docs/lua/Game-Script-Environment/Userdata/Color) userdata object is to call [sm.color.new](/docs/lua/Game-Script-Environment/static_functions/sm.color#new). <br></br>
...
To check if a script is running in server mode at runtime you can also use [sm.isServerMode](/docs/lua/Game-Script-Environment/static_functions/sm#isservermode). <br></br>
