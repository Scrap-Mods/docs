...
**Associated object type:** [Color](/docs/game_script_env/userdata/Color)
...
- [<strong> <a href="/docs/game_script_env/userdata/Color"> Color </a> </strong>]: The created color object.
