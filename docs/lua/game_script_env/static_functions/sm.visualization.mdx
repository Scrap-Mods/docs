...
**Associated object type:** [BlueprintVisualization](/docs/lua/game_script_env/userdata/BlueprintVisualization)
...
Creates a [Blueprint Visualization](/docs/lua/game_script_env/userdata/BlueprintVisualization) from blueprint data.
...
- [<strong> <a href="/docs/lua/game_script_env/userdata/BlueprintVisualization"> BlueprintVisualization </a> </strong>]: The blueprint visualization.
...
- <code>shape</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Shape"> Shape </a> </strong>]: The root Shape for comparing the creation from.
...
- [<strong> <a href="/docs/lua/game_script_env/userdata/BlueprintVisualization"> BlueprintVisualization </a> </strong>]: The builder guide blueprint visualization.
...
- <code>position</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The world position of the block. Local position if using a target.
...
- <code>pos</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The visualization position.
...
- <code>pos</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The position of the lift.
