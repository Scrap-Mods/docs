...
**Associated object type:** [Character](/docs/lua/game_script_env/userdata/Character)
...
- <code>player</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Player"> Player </a> </strong>]: The player controlling the character.
- <code>world</code> [<strong> <a href="/docs/lua/game_script_env/userdata/World"> World </a> </strong>]: The world the character is created in.
- <code>position</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The world position of the character.
...
- [<strong> <a href="/docs/lua/game_script_env/userdata/Character"> Character </a> </strong>]: The created character.
