...
Sends an event to the specified [Character](/docs/lua/game_script_env/userdata/Character)'s script. <br></br>
...
Sends an event to the specified [harvestable](/docs/lua/game_script_env/userdata/Harvestable)'s script. <br></br>
The callback function is executed in the next Lua tick.
...
Sends an event to the specified [interactable](/docs/lua/game_script_env/userdata/Interactable)'s script. <br></br>
The callback function is executed in the next Lua tick.
...
Sends an event to the specified [player](/docs/lua/game_script_env/userdata/Player)'s script. <br></br>
The callback function is executed in the next Lua tick.
...
Sends an event to the specified [scriptableObject](/docs/lua/game_script_env/userdata/ScriptableObject)'s script. <br></br>
The callback function is executed in the next Lua tick.
...
Sends an event to the specified [tool](/docs/lua/game_script_env/userdata/Tool)'s script. <br></br>
The callback function is executed in the next Lua tick.
...
Sends an event to the specified [unit](/docs/lua/game_script_env/userdata/Unit)'s script. <br></br>
The callback function is executed in the next Lua tick.
...
Sends an event to the specified [world](/docs/lua/game_script_env/userdata/World)'s script. <br></br>
The callback function is executed in the next Lua tick.
