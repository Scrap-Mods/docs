...
[Constants](/docs/game_script_env/Constants#smphysicsfilter)
...
- <code>target</code> [<strong> <a href="/docs/game_script_env/userdata/Shape"> Shape </a>/body/character </strong>]: The target that the impulse is applied to.
- <code>impulse</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The direction and strength of the impulse.
...
- <code>offset</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The offset from the center point. Defaults to none.
...
Applies a torque impulse to a [Body](/docs/game_script_env/userdata/Body), changing its angular velocity immediately. <br></br>
The torque is applied along the body's center of mass, making it rotate.

<strong>Arguments:</strong> <br></br>

- <code>target</code> [<strong> <a href="/docs/game_script_env/userdata/Body"> Body </a> </strong>]: The body that the torque is applied to.
- <code>torque</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The direction and strength of the torque.
...
- <code>start</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The start position.
- <code>direction</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The ray's direction and length.
...
Shapes that are within the explosion's destruction radius may receive the event [server_onExplosion](/docs/game_script_env/classes/shape_class#onexplosion).
...
- <code>position</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The center point of the explosion.
...
- <code>ignoreShape</code> [<strong> <a href="/docs/game_script_env/userdata/Shape"> Shape </a> </strong>]: The shape to be ignored. Optional.
...
- <code>position</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The position of the sphere.
...
The returned [RaycastResult](/docs/game_script_env/userdata/RaycastResult) contains information about any object intersected by the ray.

If the ray cast is called from within a shape (e.g. a Sensor), a [Body](/docs/game_script_env/userdata/Body) may be provided which the ray will not intersect.

<strong>Arguments:</strong> <br></br>

- <code>startPos</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The start position.
- <code>endPos</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The end position.
- <code>body</code> [<strong> <a href="/docs/game_script_env/userdata/Body"> Body </a> </strong>]: The body to ignore. Defaults to none.
...
- [<strong> <a href="/docs/game_script_env/userdata/RaycastResult"> RaycastResult </a> </strong>]: The raycast result data.
...
A target [Body](/docs/game_script_env/userdata/Body) must be provided.
...
- <code>startPos</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The start position.
- <code>endPos</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The end position.
- <code>body</code> [<strong> <a href="/docs/game_script_env/userdata/Body"> Body </a> </strong>]: The body be exclusively checked.
...
- <code>worldPosition</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The sphere position.
