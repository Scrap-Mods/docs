...
[Constants](/docs/game_script_env/Constants#smpathfinderconditionproperty)
...
- <code>character</code> [<strong> <a href="/docs/game_script_env/userdata/Character"> Character </a> </strong>]: The character to find a path for.
- <code>destination</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The path destination.
...
- <code>worldPosition</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The position to check.
