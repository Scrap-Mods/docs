...
**Associated object type:** [Tool](/docs/lua/game_script_env/userdata/Tool)
...
For more information about creating your own scripted tools, see [ToolClass](/docs/lua/game_script_env/classes/tool_class).

[Constants](/docs/lua/game_script_env/Constants#smtoolinteractstate)
...
- <code>position</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The lift position.
