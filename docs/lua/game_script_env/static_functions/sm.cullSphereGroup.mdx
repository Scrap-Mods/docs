...
**Associated object type:** [CullSphereGroup](/docs/game_script_env/userdata/CullSphereGroup)
...
- [<strong> <a href="/docs/game_script_env/userdata/CullSphereGroup"> CullSphereGroup </a> </strong>]: The sphere group.
