...
**Associated object type:** [World](/docs/game_script_env/userdata/World)
...
[Constants](/docs/game_script_env/Constants#smworldids)
...
- [<strong> <a href="/docs/game_script_env/userdata/World"> World </a> </strong>]: The created world.
...
- [<strong> <a href="/docs/game_script_env/userdata/World"> World </a> </strong>]: The current world.
...
- <code>position</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The position of the sphere. Optional.
...
- [<strong> <a href="/docs/game_script_env/userdata/World"> World </a> </strong>]: The world (id 0) if it exists in the database or nil.
