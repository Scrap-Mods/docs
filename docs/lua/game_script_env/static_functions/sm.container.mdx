...
**Associated object type:** [Container](/docs/game_script_env/userdata/Container).
...
- <code>container</code> [<strong> <a href="/docs/game_script_env/userdata/Container"> Container </a> </strong>]: The container.
- <code>itemUuid</code> [<strong> <a href="/docs/game_script_env/userdata/Uuid"> Uuid </a> </strong>]: The item uuid.
...
- <code>container</code> [<strong> <a href="/docs/game_script_env/userdata/Container"> Container </a> </strong>]: The source container.
- <code>container</code> [<strong> <a href="/docs/game_script_env/userdata/Container"> Container </a> </strong>]: The target container.
...
- <code>container</code> [<strong> <a href="/docs/game_script_env/userdata/Container"> Container </a> </strong>]: The container to assign.
- <code>player</code> [<strong> <a href="/docs/game_script_env/userdata/Player"> Player </a> </strong>]: The player to receive the carry content and color.
- <code>color</code> [<strong> <a href="/docs/game_script_env/userdata/Color"> Color </a> </strong>]: The color to assign.
...
- <code>container</code> [<strong> <a href="/docs/game_script_env/userdata/Container"> Container </a> </strong>]: The first container.
- <code>container</code> [<strong> <a href="/docs/game_script_env/userdata/Container"> Container </a> </strong>]: The second container.
