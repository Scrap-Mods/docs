...
- <code>body</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Body"> Body </a> </strong>]: Any body in the creation.
...
- <code>world</code> [<strong> <a href="/docs/lua/game_script_env/userdata/World"> World </a> </strong>]: The world to import to.
- <code>pathString</code> [<strong> string </strong>]: The path to the blueprint file.
- <code>worldPosition</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The world position of the creation. Defaults to <code>sm.vec3.zero()</code>
