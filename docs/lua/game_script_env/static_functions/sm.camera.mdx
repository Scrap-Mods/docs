...
The camera library contains methods related to the [localPlayer](/docs/game_script_env/static_functions/sm.localPlayer)'s camera view.
...
[Constants](/docs/game_script_env/Constants#smcamerastate)
...
- <code>direction</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The cast direction and range.
...
Returns the camera's control state, see [sm.camera.states](/docs/game_script_env/Constants#smcamerastate).
...
- [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The position.
...
- [<strong> <a href="/docs/game_script_env/userdata/Quat"> Quat </a> </strong>]: The rotation.
...
- [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The direction.
...
- [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The camera's right-vector.
...
- [<strong> <a href="/docs/game_script_env/userdata/Quat"> Quat </a> </strong>]: The camera's rotation.
...
- [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The camera's up-vector.
...
Sets the camera's control state, see [sm.camera.states](/docs/game_script_env/Constants#smcamerastate).
