...
**Associated object type:** [Effect](/docs/game_script_env/userdata/Effect)
...
- [<strong> <a href="/docs/game_script_env/userdata/Effect"> Effect </a> </strong>]: The created effect.
...
- <code>velocity</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The velocity. Defaults to none.
- <code>rotation</code> [<strong> <a href="/docs/game_script_env/userdata/Quat"> Quat </a> </strong>]: The rotation. Defaults to none.
- <code>scale</code> [<strong> <a href="/docs/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The scale, if using a renderable. Defaults to none.
