...
Returns data for the character [shape](/docs/lua/game_script_env/userdata/Shape).
...
Returns data for the edible [shape](/docs/lua/game_script_env/userdata/Shape).
...
Returns data for the plantable [shape](/docs/lua/game_script_env/userdata/Shape).
...
- [<strong> <a href="/docs/lua/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The offset.
...
- [<strong> <a href="/docs/lua/game_script_env/userdata/Vec3"> Vec3 </a> </strong>]: The shape size.
