...
**Associated object type:** [Player](/docs/game_script_env/userdata/Player)

A <strong>player</strong> is a user playing the game. Every player controls a [Character](/docs/game_script_env/userdata/Character) in the world.
