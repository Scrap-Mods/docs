...
**Associated object type:** [Uuid](/docs/lua/game_script_env/userdata/Uuid)
...
- <code>namespace</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Uuid"> Uuid </a> </strong>]: A uuid namespace for the name. The namespace makes sure any equal name from different namespaces do not collide.
...
- [<strong> <a href="/docs/lua/game_script_env/userdata/Uuid"> Uuid </a> </strong>]: The created uuid.
...
- [<strong> <a href="/docs/lua/game_script_env/userdata/Uuid"> Uuid </a> </strong>]: The generated uuid.
