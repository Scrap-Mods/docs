...
Returns a table of [interactables](/docs/lua/game_script_env/userdata/Interactable) that contain the given tag for a cell coordinate.
...
Returns a table of [interactables](/docs/lua/game_script_env/userdata/Interactable) that contain all of the given tags for a cell coordinate.
...
- <code>x</code> [<strong> int </strong>]: The X coordinate.
- <code>y</code> [<strong> int </strong>]: The Y coordinate.
- <code>uuid</code> [<strong> <a href="/docs/lua/game_script_env/userdata/Uuid"> Uuid </a> </strong>]: The uuid of the interactable(s).
