...
| Data       | [BlobData](../common-structures/blobdata.mdx)[until EOS] | The data the scripted classes are initialized with. This array is read until the end of the packet. |

## BlobData Payloads

In this subsection, UIDs of known [BlobData](../common-structures/blobdata.mdx) and their payloads are listed. This is not guaranteed to be an exhaustive list.

### World Info

This [BlobData](../common-structures/blobdata.mdx) contains information about the world the player is currently joining.
...
| Filename     | [String](../common-structures/string.mdx) | The filename of the world. |
| Classname    | [String](../common-structures/string.mdx) | The classname of the world. |
| Terrain Params | [String](../common-structures/string.mdx) | A stringified JSON object containing the terrain parameters of the world. |

### Gameplay Options

This [BlobData](../common-structures/blobdata.mdx) contains the gameplay options of the world.
...
| Field Name | Field Type | Notes |
|------------|------------|-------|
| Options    | [String](../common-structures/string.mdx) | A stringified JSON object containing the gameplay options of the world. |
...
This [BlobData](../common-structures/blobdata.mdx) contains information about a player.
...
| Character Customization | [Character Customization](../../structures/docs/character-customization) | The customization options of the character of the player. |